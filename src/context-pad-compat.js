// bpmn-js 18.21's ContextPadProvider still calls the deprecated diagram-js ContextPad#getPad to position
// the replace menu, which logs a deprecation warning on every wrench click and will break outright once
// getPad is removed. Reimplement getPad with the current API (the context pad is positioned in the canvas
